...
import 'package:ppk/bloc/dummy_login/dummy_login_bloc.dart';
...
class SlideScreen extends StatelessWidget {
                              ...
                              return Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Center(
                                        child: Text('если уже были с нами',
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodyLarge!
                                                .copyWith(
                                      ...
                                      BlocProvider(
                                        ...
                                        child: Builder(builder: (context) {
                                          return BlocBuilder<DummyLoginBloc,
                                              DummyLoginState>(
                                            builder: (context, state) {
                                              return BlocListener<DummyLoginBloc,
                                                  DummyLoginState>(
  ...
  child: Center(
                                                child: InkWell(
                                                  onTap: () async {
                                                    BlocProvider.of<DummyLoginBloc>(context).add(Login());},
                                                  child: Container(
